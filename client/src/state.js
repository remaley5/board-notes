...
const SELECTED_PHOTOS = "__selected_photos__"
...
export const setSelectedPhotos = (photos) => {
  localStorage.setItem(SELECTED_PHOTOS, JSON.stringify(photos))
}

export const getSelectedPhotos = () => {
