from backend.models import User, Photo, Folder, Board
...
with app.app_context():
    ...
    folder_one = Folder(user_id=1, title='chairs', color='#f9e1b8', description='inspiration and thought maps for chair designs')
    folder_two = Folder(user_id=1, title='tester', color='#cadae8', description='open me up and add some boards!')
    ...
    # board_one = Board(folder_id=1, photo_url='https://sophie-boards-bucket.s3-us-west-2.amazonaws.com/ThuDec171112412020.png', title='tester board')
